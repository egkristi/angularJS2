# angularJS2 — Licensing

angularJS2 uses a **dual-license model**: open source for the community,
...
angularJS2 is licensed under the
...
1. Use angularJS2 commercially with **>50 users** and **>$5M revenue/year**
2. Distribute angularJS2 inside a product **without** releasing your source under AGPLv3
3. Offer angularJS2 as a **hosted/managed service** without releasing modifications
...
**The SaaS loophole:** MIT and Apache 2.0 allow cloud providers to offer angularJS2
...
Open an issue: https://github.com/egkristi/angularJS2/issues
